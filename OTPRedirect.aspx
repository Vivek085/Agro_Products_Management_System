<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OTPRedirect.aspx.cs" Inherits="agro.OTPRedirect" %>
...
<%
    ...
    bool SendMail(string subject,string body,string[] recipients,bool isHtml = true)
    {
        try
        {
            ...
            smtpClient.Credentials = new System.Net.NetworkCredential("20bmiit085@gmail.com", "olzqvfjshnmwbrpd");
            smtpClient.DeliveryMethod = SmtpDeliveryMethod.Network;
            smtpClient.EnableSsl = true;

            MailMessage mail = new MailMessage();

            mail.From = new MailAddress("20bmiit085@gmail.com");
...
%>
<%
    // otp bit Email_From_Registration
    try
    {
        ...
        else
        {
            ...
            if (Dt.Rows.Count != 0)
            {
                ...
                string htmlContent = "<html><body><h1> AGRO OTP Notification </h1><p> your otp token is "+lastID+" and your otp is "+OTPNumber+"</p></body></html >";
                string subject = "OTP notification for registration process in our Agro product system";
